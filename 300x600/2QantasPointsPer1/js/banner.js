...
function initCSS() {
    ...
    TweenLite.set(".terms-frame-03", {autoAlpha:0});
...
function startAnimation() {
    ...
    tl.to("#partnership-white-shape-small", 2, {autoAlpha:1, x:-300, y:10, scaleX:2.2, ease: Power1.easeIn}, "frame02");
    ...
    tl.from("#frame-02-word-03", 0.8, {autoAlpha:0, y:10, ease: Sine.easeOut}, "frame02+=1");
    tl.from("#frame-02-word-04", 0.8, {autoAlpha:0, y:10, ease: Sine.easeOut}, "frame02+=1.1");
    tl.from("#frame-02-word-05", 0.8, {autoAlpha:0, y:10, ease: Sine.easeOut}, "frame02+=1.2");
    ...
    tl.from(".terms-frame-02", 1.5, {alpha: 0, ease: Power1.easeInOut}, "frame02+=.7");
    ...
    tl.to(".terms-frame-02", 1, {alpha: 0, y: 0, ease: Power1.easeOut}, "frame03");
    tl.from(".terms-endframe", 1.5, {alpha: 0, ease: Power1.easeInOut}, "frame03+=.1");
    ...
    tl.to(".logo-qantas", 0.8, {alpha:0, y:0, ease: Power1.easeInOut}, "endframe");
    ...
    // tl.to(".terms-frame-02", 1, {alpha: 0, y: 0, ease: Power1.easeOut}, "endframe");
