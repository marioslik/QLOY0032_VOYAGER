...
function startAnimation() {
    ...
    tl.from(".cardWrapper", 1.5, {alpha: 0, x:-5, ease: Sine.easeOut}, "1.5");

    tl.from("#frame01-line-01", 2, {autoAlpha:0, y:-5, ease: Sine.easeOut}, "1.5");
    tl.from("#frame01-line-02", 2, {autoAlpha:0, y:-5, ease: Sine.easeOut}, "1.7");
    tl.from("#frame01-line-03", 2, {autoAlpha:0, y:-5, ease: Sine.easeOut}, "1.9");
    ...
    tl.from("#frame-02-word-01", 0.5, {scale:0, ease: Sine.easeOut}, "frame02+=0.6");
    tl.from("#frame-02-word-02", 0.5, {scale:0, ease: Sine.easeOut}, "frame02+=0.8");
    tl.from("#frame-02-word-03", 0.8, {autoAlpha:0, y:5, ease: Sine.easeOut}, "frame02+=1");
    tl.from("#frame-02-word-04", 0.8, {autoAlpha:0, y:5, ease: Sine.easeOut}, "frame02+=1.1");
    tl.from("#frame-02-word-05", 0.8, {autoAlpha:0, y:5, ease: Sine.easeOut}, "frame02+=1.2");
    tl.from("#frame02-line-03", 1, {autoAlpha:0, ease: Sine.easeOut}, "frame02+=1.5");

    tl.from(".terms-frame-02", 1.5, {alpha: 0, ease: Power1.easeInOut}, "frame02+=.5");

    tl.to(".card", 1.9, {rotationY:360, ease:Back.easeInOut}, "frame02+=1.6");
    ...
    // tl.from(".terms-frame-02", 1.5, {alpha: 0, ease: Power1.easeInOut}, "frame03+=.1");

    tl.call(countDown, [900, 999, 000, "#hundreds-countdown"], this, "frame03-=0.3");
    ...
    tl.to(".terms-frame-02", 0.8, {alpha: 0, ease: Power1.easeInOut}, "frame03");
    tl.from("#messaging-endframe", 1.5, {alpha: 0, y: 5, ease: Power1.easeInOut}, "frame03+=.1");

    //END FRAME ------------------------------------------------
    tl.add("endframe", 12.5);

    tl.to("#messaging-endframe", 2, {scale:0.8, x:-86, ease: Power1.easeInOut}, "endframe+=.5");
    ...
    tl.from("#cta-button", 1, {alpha: 0, ease: Power1.easeInOut}, "endframe+=2");

    // tl.to("#logos-container", 2, {y: -23, ease: Power1.easeInOut}, "endframe");
