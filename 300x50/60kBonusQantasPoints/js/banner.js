...
function initCSS() {
    ...
    TweenLite.set($("#messaging-endframe"), {scale:0.8});
...
function startAnimation() {
    ...
    tl.from("#frame02-line-01", 1, {autoAlpha:0, y:5, ease: Sine.easeOut}, "frame02+=0.9");
    tl.from("#frame-02-word-04", 1, {autoAlpha:0, x:-5, ease: Sine.easeOut}, "frame02+=1.3");
    tl.from("#frame-02-word-05", 1, {autoAlpha:0, x:5, ease: Sine.easeOut}, "frame02+=1.4");
    tl.from("#frame02-line-03", 1, {autoAlpha:0, x:5, ease: Sine.easeOut}, "frame02+=1.7");

    tl.to(".card", 1.9, {rotationY:360, ease:Back.easeInOut}, "frame02+=1.8");
    ...
    tl.to("#messaging-frame-02", 0.8, {alpha: 0, ease: Power1.easeInOut}, "endframe");
    tl.from("#messaging-endframe", 1.5, {alpha: 0, y: 5, ease: Power1.easeInOut}, "endframe+=.1");

    tl.call(countDown, [900, 999, 000, "#hundreds-countdown"], this, "endframe-=0.4");
