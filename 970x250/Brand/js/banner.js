...
function startAnimation() {
    ...
    tl.from("#partnership-white-shape", 1.4, {autoAlpha:0, y:-25, x:-20, ease:Power1.easeInOut}, "frame02+=.6");
    tl.to("#partnership-white-shape-small", 3, {rotation:-82, x:70, y:-110, scale:1.1, ease: Power1.easeInOut}, "frame02+=.6");
    tl.to("#partnership-white-shape-small", 1.4, {x:110, ease:Power1.easeInOut}, "frame02+=.6");
