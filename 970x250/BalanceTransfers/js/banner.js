...
function startAnimation() {
    ...
    tl.from("#frame-02-word-04", 1, {autoAlpha:0, x:-10, ease: Sine.easeOut}, "frame02+=1.3");
    tl.from("#frame-02-word-05", 1, {autoAlpha:0, x:10, ease: Sine.easeOut}, "frame02+=1.5");
    tl.from("#frame-02-word-06", 1, {autoAlpha:0, x:10, ease: Sine.easeOut}, "frame02+=1.7");
