...
function startAnimation() {
    ...
    tl.from("#frame-02-word-05", 1, {autoAlpha:0, x:20, ease: Sine.easeOut}, "frame02+=1.4");
    tl.from("#frame02-line-03", 1, {autoAlpha:0, x:20, ease: Sine.easeOut}, "frame02+=1.7");
    ...
    tl.from(".terms-endframe", 1.5, {alpha: 0, ease: Power1.easeInOut}, "frame03+=1.5");
