...
function startAnimation() {
    ...
    tl.from("#frame02-line-01", 1, {autoAlpha:0, y:10, ease: Sine.easeOut}, "frame02+=0.7");
    tl.from("#frame-02-word-05", 1, {autoAlpha:0, x:-10, ease: Sine.easeOut}, "frame02+=1.3");
    tl.from("#frame-02-word-06", 1, {autoAlpha:0, x:10, ease: Sine.easeOut}, "frame02+=1.5");
    tl.from("#frame-02-word-07", 1, {autoAlpha:0, x:10, ease: Sine.easeOut}, "frame02+=1.7");
    ...
    tl.to("#messaging-endframe", 3, {x: -120, ease: Power1.easeInOut}, "endframe");
    ...
    tl.from("#cta-button", 1, {alpha: 0, ease: Power1.easeInOut}, "endframe+=1.5");
