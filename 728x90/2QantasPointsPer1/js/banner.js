...
function initCSS() {
    ...
    TweenLite.set(".cardWrapper", {perspective:800, scale:0.7});
    TweenLite.set(".card", {transformStyle:"preserve-3d"});
    TweenLite.set(".back", {rotationY:-180});
    TweenLite.set(".terms-endframe", {autoAlpha:0});
...
function startAnimation() {
    ...
    tl.to("#red-gradient", 1.5, {rotation:35, autoAlpha:1, x:-150, y:-330, scale:1.2, ease: Power1.easeOut}, "endframe+=2");
    ...
    tl.from("#cta-button", 1, {alpha: 0, ease: Power1.easeInOut}, "endframe+=0.5");
